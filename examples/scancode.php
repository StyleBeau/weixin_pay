<b>请直接查看scancode.php 文件</b>

<?php

require_once "../src/weixin_pay.class.php";
require_once "./phpqrcode.php";		//生成二维码的类
...
$wxpay=new weixin_scancode_pay($parameter);

//统一下单   
//$re=$wxpay->unifiedorder('20150703100','1001','测试扫码下单','0.01','http://xxxx.com/wap/notify/wx_notify');
//
//$value = $re['code_url']; 		//二维码内容
//$Level = 'QR_ECLEVEL_L';		//容错级别
//$Size = 10;					//生成图片大小   
//QRcode::png($value, false, $Level, $Size);   //生成二维码图片
